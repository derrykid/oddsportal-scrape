...
global TYPE_ODDS
TYPE_ODDS = 'CLOSING'  # you can change to 'OPENING' if you want to collect opening odds,
...
def get_data_typeA(i, link):
    ...
    # sleep the thread, see if this is why we cannot click the link
    time.sleep(5)

    # target = '//*[@id="tournamentTable"]/tbody/tr[{}]/td[2]/a'.format(i)
    # the target ahref needs constant attention
    target1 = '/html/body/div[1]/div/div[1]/div/main/div[2]/div[5]/div[1]/div[{}]/div/div/a'.format(i)
    target2 = '/html/body/div[1]/div/div[1]/div/main/div[2]/div[5]/div[1]/div[{}]/div[2]/div/a'.format(i)
    ...
    if a or b:
        ...
        for j in range(startbooker, 30):  # only first 10 bookmakers displayed
            # bookmaker xpath
            Book = ffi('/html/body/div[1]/div/div[1]/div/main/div[2]/div[4]/div[1]/div/div[{}]/div[1]/a[2]/p'.format(j))  # first bookmaker name
            Odd_1 = fffi('/html/body/div[1]/div/div[1]/div/main/div[2]/div[4]/div[1]/div/div[{}]/div[2]/div/div/p'.format(j))  # first home odd
            draw = fffi('/html/body/div[1]/div/div[1]/div/main/div[2]/div[4]/div[1]/div/div[{}]/div[3]/div/div/p'.format(j))  # first draw odd
            Odd_2 = fffi('/html/body/div[1]/div/div[1]/div/main/div[2]/div[4]/div[1]/div/div[{}]/div[4]/div/div/p'.format(j))  # first away odd
            
            match = ffi('/html/body/div[1]/div/div[1]/div/main/div[2]/div[3]/div[1]')  # match teams

            final_score = ffi('/html/body/div[1]/div/div[1]/div/main/div[2]/div[3]/div[2]/div[3]/div[2]/strong')
            date = ffi('/html/body/div[1]/div/div[1]/div/main/div[2]/div[3]/div[2]/div[1]/div[2]')  # Date and time

            if Book is None:
                break

            print(match, Book, Odd_1, Odd_2, date, final_score, i, '/ 500 ')
            L = L + [(match, Book, Odd_1, draw, Odd_2, date, final_score)]

        return L

    print(f"There is a none {target1}")
    return None
...
def scrape_current_tournament_typeA(sport, tournament, country, SEASON, max_page=25):
    ...
    data_df.to_csv('football.csv', index=False, encoding='utf-8')
    try:
...
def scrape_oddsportal_historical(sport='football', country='france', league='ligue-1', start_season='2019-2020',
    ...
    L = ['football' ,'soccer', 'basketball', 'esports', 'darts', 'tennis', 'baseball', 'rugby-union', 'rugby-league',
         'american-football', 'hockey', 'volleyball', 'handball']
    ...
    if sport in ['football', 'baseball', 'esports', 'basketball', 'darts', 'american-football', 'volleyball']:
...
def scrape_oddsportal_specific_season(sport='football', country='france', league='ligue-1', season='2019-2020',
    ...
    if sport in ['baseball', 'esports', 'basketball', 'darts', 'american-football', 'volleyball']:
        df = scrape_current_tournament_typeA(sport=sport, tournament=league, country=country, SEASON=season,
                                             max_page=max_page)
        df = create_clean_table_two_ways(df)
    # elif sport in ['tennis']:
